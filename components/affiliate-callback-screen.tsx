...
export function AffiliateCallbackScreen({ code, state }: { code: string | null; state: string | null }) {
  ...
  return <section className="rounded-3xl bg-[#140f1c] p-8 text-white" aria-live="polite">
    ...
    {failed && <><p className="mt-4">Return to the age gate to check your status or try again.</p><a className="mt-5 inline-block underline" href="/affiliate-demo">Return to JerkMeat</a></>}
  </section>;
}
