  ...
  return <JerkMeatSite gate={<>
    ...
    <div className={styles.gateContent}>
      ...
      <div className={styles.gateActions}>{verified ? <>
        <p role="status" className={styles.goldStatus} data-local-edit={process.env.NODE_ENV === "development" ? "ve-c1534dd01fe7-1" : undefined}><span aria-hidden="true">✓</span> Age verified with Zik</p>
        <a href="/affiliate-demo/continue" className={styles.pinkButton} data-local-edit={process.env.NODE_ENV === "development" ? "ve-c1534dd01fe7-2" : undefined}>Continue / Log in</a>
